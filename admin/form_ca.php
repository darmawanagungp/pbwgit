...
{    
    ...
    mysqli_query($con,"insert into gallery values('','".date('Y-m-d')."','".($getId[0]+1).$ext."', '$judul')");
...
elseif(isset($_POST['update']))
{
    ...
    { 
        ...
        mysqli_query($con,"update gallery set judul='$judul', gambar='".$_GET['id'].$ext."' where id='".$_GET['id']."'");
    }
    else
        mysqli_query($con,"update gallery set judul='$judul' where id='".$_GET['id']."'");
