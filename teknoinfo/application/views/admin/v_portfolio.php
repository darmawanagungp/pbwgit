...
<head>
  ...
  <title>Teknologi Informasi | Profil Lulusan</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'admin/portfolio/add_portfolio'?>"><i class="fa fa-thumb-tack"></i> Add Profil Lulusan</a></li>
            <li class="active"><a href="<?php echo base_url().'admin/portfolio'?>"><i class="fa fa-list"></i> List Profil Lulusan</a></li>
          </ul>
        </li>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/portfolio/add_portfolio'?>"><span class="fa fa-plus"></span> Add Profil Lulusan</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Hapus Profil Lulusan</h4>
                    </div>
                    ...
                    <div class="modal-body">
                     ...
                     <input type="hidden" value="<?php echo $port_gambar;?>" name="gambar">
                            <p>Apakah Anda yakin mau menghapus Profil Lulusan <b><?php echo $port_judul;?></b> ?</p>
