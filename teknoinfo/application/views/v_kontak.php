			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>Gedung Teknologi Informasi, ITS-Surabaya</li>
						<li><i class="icon-phone"></i>+ 1235 2355 98</li>
						<li><i class="icon-envelope"></i><a href="#">info@ti-its.com</a></li>
						<li><i class="icon-globe"></i><a href="#">www.ti-its.com</a></li>
					</ul>
				</div>
