...
<div class="banner inner-banner-w3-agileits" id="home">
	...
	<div class="top-header-agile">
		<h1><a class="col-md-4 navbar-brand" href="index.php">ITS<span>Teknologi Informasi</span></a></h1>
		...
		<nav class="navbar navbar-default">
			...
			<?php include 'navbar.php'; ?>
				<h2 class="inner-tittle-w3layouts">Tentang Kami</h2>
		</div>
	</div>
</div>
<!-- //banner -->
...
<div class="container">
	<h3 class="tittle-agileits-w3layouts">Kami bekerja keras untuk mempersiapkan setiap <span class="green-w3"> mahasiswa</span> untuk siap bersaing <span> di masa depan</span></h3>
	<div class="abt-img"></div>
	<div class="abt-iinfo-w3ls">
		<div class="col-md-4 about-grids">
			<h5>Terkareditasi A</h5>
			<p class="para-w3-agile">Departemen Teknologi Infomasi telah memiliki akreditasi A dari BAN-PT.</p>
		</div>
		<div class="col-md-4 about-grids">
			<h5>Jurusan terbaik</h5>
			<p class="para-w3-agile">Teknologi Informasi merupakan jurusan terbaik yang selalu berusaha memberikan segala aspek pendukung pembelajaran yang terbaik. </p>
		</div>
		<div class="col-md-4 about-grids">
			<h5>Banyak Pilihan Mata Kuliah</h5>
			<p class="para-w3-agile">Di Departemen Teknologi Informasi ini kalian bisa memilih mata kuliah yang sesuai dengan bidang kalian.</p>
		</div>
	</div>
</div>
</div>
...
<div class="property-grids">
	<div class="container">
		<h2 class="tittle-agileits-w3layouts">Our <span>Facilities</span></h2>
			<h3>Laboratorium</h3>
			<p class="para-w3-agile">Terdapat 2 Laboratorium Komputer (Lab Kemanan Siber dan Lab Teknologi <em>Smart City</em>), seluruh Komputer telah dilengkapi oleh perangkat lunak yang dapat digunakan untuk mendukung kegiatan praktikum maupun kegiatan akademis lainnya</p> <br>
			<h3>Ruang Baca</h3>
			<p class="para-w3-agile">Memiliki berbagai macam koleksi mulai dari fiksi hingga materi perkuliahan, dari bahan cetak hingga koleksi digital seperti CD-ROM, CD, VCD dan DV. Selain itu juga menyediakan publikasi serial harian dan bulanan seperti surat kabar dan majalah.</p> <br>
			<h3>Ruang Kelas</h3>
			<p class="para-w3-agile">Setiap ruang dilengkapi dengan pendingin ruangan dan LCD erta akses internet gratis yang dapat mendukung kegiatan akademis mahasiswa.</p>
	</div>
...
<!-- Stats -->
	...
	<div class="container">
	<h3 class="tittle-agileits-w3layouts">Doing the <span class="green-w3">right thing,</span> at the <span>right time.</span></h3>
		<div class="stats-info agileits w3layouts">
			<div class="col-md-3 agileits w3layouts col-sm-3 stats-grid stats-grid-1">
				<div class="numscroller agileits-w3layouts" data-slno='1' data-min='0' data-max='30' data-delay='3' data-increment="1">30</div>
				<div class="stat-info-w3ls">
					<h4 class="agileits w3layouts">Teachers</h4>
				</div>
			</div>
			...
			<div class="col-md-3 col-sm-3 stats-grid agileits w3layouts stats-grid-3">
				<div class="numscroller agileits-w3layouts" data-slno='1' data-min='0' data-max='15' data-delay='3' data-increment="1">15</div>
				<div class="stat-info-w3ls">
					<h4 class="agileits w3layouts">Years</h4>
				</div>
			</div>
			<div class="col-md-3 col-sm-3 stats-grid stats-grid-4 agileits w3layouts">
				<div class="numscroller agileits-w3layouts" data-slno='1' data-min='0' data-max='200' data-delay='3' data-increment="1">200</div>
				<div class="stat-info-w3ls">
		...
		<div class="container">
			<div class="footer-row w3layouts-agile">
				<div class="col-md-4 footer-grids w3l-agileits">
					<h6><a href="index.php">Teknologi Informasi</a></h6>
