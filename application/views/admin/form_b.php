...
{    
    ...
    mysqli_query($con,"insert into berita values('','".date('Y-m-d')."','".($getId[0]+1).$ext."','$link', '$judul' , '$konten')");
...
elseif(isset($_POST['update']))
{
    ...
    { 
        ...
        mysqli_query($con,"update berita set judul='$judul', link='$link', gambar='".$_GET['id'].$ext."',konten='$konten' where id='".$_GET['id']."'");
    }
    else
        mysqli_query($con,"update berita set judul='$judul', link='$link', konten='$konten' where id='".$_GET['id']."'");
                ...
                <form class="form-horizontal" method="post" enctype="multipart/form-data">
                   ...
                   <input type="hidden" name="gambar" value="<?php echo isset($data[2])?$data[2]:''; ?>">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="tiga" class="col-sm-2 control-label">Link Blog</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Link" name="link" id="tiga" value="<?php echo isset($data[9])?$data[9]:''; ?>">
                            </div>
                        </div>
                        <div class="form-group">
