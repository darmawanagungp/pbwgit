<aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview">
              <a href="#">
                <i class="glyphicon glyphicon-file"></i> <span>Gallery</span>
                <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li><a href="index.php?page=gallery"><i class="glyphicon glyphicon-pencil"></i> Input Gallery</a></li>
                <li><a href="index.php?page=list_gallery"><i class="glyphicon glyphicon-list"></i> List Gallery</a></li>
              </ul>
            </li> 
